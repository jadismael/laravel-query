...
use Jadismael\LaravelQuery\Services\Query\{
    OperatorRegistry,
    FilterParser,
    ResourceQueryExecutor,
    QueryFilters,
    QuerySort,
    QueryInclude,
    ResourceQueryBuilder,
    ResourceQueryBuilderFactory
};
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ResourceQueryBuilder::class, function ($app, $params) {
            return new ResourceQueryBuilder(
                ...
                $app->make(QuerySort::class, ['modelColumns' => $params['modelColumns']]),
                $app->make(QueryInclude::class, ['model' => $params['model']])
            );
        });
